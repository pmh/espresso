...
$elf["send:args:"]("set:to:", ["Person", $elf["send:"]("Object")["send:"]("clone")]);

$elf["send:"]("Person")["send:args:"]("set:to:", ["named:", (function(body) { body.type = "Method"; return body; })((function (name) {
  var self = this, self.clone();
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("named:", [name]); })
  $elf["name"] = (name && name.type === "Array") ? name[0] : ((typeof name !== "undefined") ? name : nil);
  return $elf["send:args:"]("clone:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return self["send:args:"]("set:to:", ["name", $elf["send:"]("name")]);
  })]]);
}))]);

$elf["send:"]("Person")["send:args:"]("set:to:", ["greet:with:", (function(body) { body.type = "Method"; return body; })((function (person, message) {
  var self = this, self.clone();
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("greet:with:", [person, message]); })
  $elf["person"] = (person && person.type === "Array") ? person[0] : ((typeof person !== "undefined") ? person : nil); $elf["message"] = (message && message.type === "Array") ? message[0] : ((typeof message !== "undefined") ? message : nil);
  return [$elf["send:"]("name"), " says: ", $elf["send:"]("message"), ", ", $elf["send:"]("person")["send:"]("name"), "!"].join("")["send:"]("println");
}))]);

$elf["send:args:"]("set:to:", ["patrik", $elf["send:"]("Person")["send:args:"]("named:", [["Patrik"]])]);

$elf["send:args:"]("set:to:", ["dude", $elf["send:"]("Person")["send:args:"]("named:", [["Dude"]])]);

$elf["send:"]("patrik")["send:args:"]("greet:with:", [[$elf["send:"]("dude")], ["Hello"]]);

$elf["send:"]("String")["send:args:"]("set:to:", ["clone", (function(body) { body.type = "Method"; return body; })((function () {
  var self = this, $elf = Object.create(self); $elf.proto = self; $elf.delegates = [];
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("clone", []); })
  return self;
}))]);
