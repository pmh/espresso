...
module.exports = function (_) {
  return {
    ...
    UnaryMsg: function (attr, receiver, message) {
      if (message.hasType("KeywordMsg") || message.hasType("BinaryMsg") || message.hasType("AssignMsg"))
        return join(receiver, _.translate(message));
      else if (message.hasType("Number"))
    ...
    AssignMsg: function (attr, id, expr) {
      return join('["send:args:"]("', attr.operator() , '", ["', id.value(), '", ', this.implicit_self(expr) ,']',')')
    },
