...
$elf["send:"]("Array")["send:args:"]("set:to:", ["push:", (function(body) { body.type = "Method"; return body; })((function (element) {
  var self = this, $elf = self.clone();
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("push:", [element]); })
