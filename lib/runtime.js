...
$elf["send:"]("Object")["send:args:"]("define-method:predicates:do:", [["inherits?:"], [[true]], [(function (object) {
  ...
  return self["send:"]("proto")["send:args:"]("if_true:if_false:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return self["send:"]("proto")["send:args:"]("==", [$elf["send:"]("object")])["send:args:"]("||", [method(function () { return $elf["send:"]("forward"); })]);
  })], [(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return false;
  })]]);
...
$elf["send:"]("Number")["send:args:"]("define-method:predicates:do:", [["<=>"], [[]], [(function (other) {
  ...
  return self["send:args:"]("==", [$elf["send:"]("other")])["send:args:"]("if_true:if_false:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return (Number._cache["0"] || (Number._cache["0"] = new Number("0")));
  })], [(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return self["send:args:"]("<", [$elf["send:"]("other")])["send:args:"]("if_true:if_false:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
      var $elf = this.clone();
      return (Number._cache["1"] || (Number._cache["1"] = new Number("1")));
    })], [(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
      var $elf = this.clone();
      return (Number._cache["-1"] || (Number._cache["-1"] = new Number("-1")));
    })]]);
...
$elf["send:"]("Number")["send:args:"]("define-method:predicates:do:", [["times:current-count:"], [[true,(function () {
  ...
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("times:current-count:", [blk, i]); });
  $elf["blk"] = (blk && blk.type === "Array") ? blk[0] : ((typeof blk !== "undefined") ? blk : nil); $elf["i"] = (i && i.type === "Array") ? i[0] : ((typeof i !== "undefined") ? i : nil);
  ___ret___ = $elf["send:"]("blk")["send:args:"]("call:", [[$elf["send:"]("i")["send:args:"]("+", [(Number._cache["1"] || (Number._cache["1"] = new Number("1")))])]]);
  if (typeof ___ret___ !== "undefined" && typeof ___ret___.ret !== "undefined") { return ___ret___.ret };
  return self["send:args:"]("times:current-count:", [[$elf["send:"]("blk")], [$elf["send:"]("i")["send:args:"]("+", [(Number._cache["1"] || (Number._cache["1"] = new Number("1")))])]]);
})]]);
...
$elf["send:"]("Number")["send:args:"]("define-method:predicates:do:", [["times:"], [[true]], [(function (blk) {
  ...
  $elf["blk"] = (blk && blk.type === "Array") ? blk[0] : ((typeof blk !== "undefined") ? blk : nil);
  return self["send:args:"]("times:current-count:", [[$elf["send:"]("blk")], [(Number._cache["0"] || (Number._cache["0"] = new Number("0")))]]);
})]]);

$elf["send:"]("Number")["send:args:"]("define-method:predicates:do:", [["from:"], [[true]], [(function (value) {
  var ___ret___ = undefined, self = (this.type === "Number" ? (Number._cache[this] || (Number._cache[this] = new Number(this))) : this), $elf = self.clone();
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("from:", [value]); });
  $elf["value"] = (value && value.type === "Array") ? value[0] : ((typeof value !== "undefined") ? value : nil);
  return (Number._cache[value[0]] || (Number._cache[value[0]] = new Number(value[0])));
})]]);
...
$elf["send:"]("String")["send:args:"]("define-method:predicates:do:", [["match:"], [[(function () {
  var self = this, $elf = arguments[0];
  return $elf["send:"]("type")["send:args:"]("==", ["RegExp"])["send:args:"]("||", [method(function () { return $elf["send:"]("type")["send:args:"]("==", ["String"]); })]);
})]], [(function (regex) {
  var ___ret___ = undefined, self = (this.type === "Number" ? (Number._cache[this] || (Number._cache[this] = new Number(this))) : this), $elf = self.clone();
...
$elf["send:"]("Array")["send:args:"]("define-method:predicates:do:", [["empty?"], [[]], [(function () {
  ...
  return $elf["send:"]("_length")["send:args:"]("==", [(Number._cache["0"] || (Number._cache["0"] = new Number("0")))]);
})]]);
...
$elf["send:"]("traits")["send:"]("Comparable")["send:args:"]("define-method:predicates:do:", [["=="], [[]], [(function (other) {
  ...
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("==", [other]); });
  $elf["other"] = (other && other.type === "Array") ? other[0] : ((typeof other !== "undefined") ? other : nil);
  return self["send:args:"]("<=>", [$elf["send:"]("other")])["send:args:"]("==", [(Number._cache["0"] || (Number._cache["0"] = new Number("0")))]);
})]]);
...
$elf["send:"]("traits")["send:"]("Comparable")["send:args:"]("define-method:predicates:do:", [["!="], [[]], [(function (other) {
  ...
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("!=", [other]); });
  $elf["other"] = (other && other.type === "Array") ? other[0] : ((typeof other !== "undefined") ? other : nil);
  return self["send:args:"]("<=>", [$elf["send:"]("other")])["send:args:"]("==", [(Number._cache["-1"] || (Number._cache["-1"] = new Number("-1")))]);
})]]);
...
$elf["send:"]("traits")["send:"]("Comparable")["send:args:"]("define-method:predicates:do:", [["<="], [[]], [(function (other) {
  ...
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("<=", [other]); });
  $elf["other"] = (other && other.type === "Array") ? other[0] : ((typeof other !== "undefined") ? other : nil);
  return self["send:args:"]("<=>", [$elf["send:"]("other")])["send:args:"]("==", [(Number._cache["1"] || (Number._cache["1"] = new Number("1")))])["send:args:"]("||", [method(function () { return self["send:args:"]("<=>", [$elf["send:"]("other")])["send:args:"]("==", [(Number._cache["0"] || (Number._cache["0"] = new Number("0")))]); })]);
})]]);
