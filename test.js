...
EObject["lookup:"] = method(function (slot_name) {
  ...
  return typeof slot === "undefined" ? ((this.proto && !this.proto["nil?"]) ? this.proto["lookup:"]([slot_name]) : ENil) : slot;
});
...
$elf["send:"]("Object")["send:args:"]("set:to:", ["inherits?:", (function(body) { body.type = "Method"; return body; })((function (object) {
  ...
  return self["send:"]("proto")["send:args:"]("if_true:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
    var $elf = this.clone();
    return self["send:"]("proto")["send:args:"]("==", [$elf["send:"]("object")])["send:args:"]("||", [self["send:"]("proto")["send:args:"]("inherits?:", [[$elf["send:"]("object")]])]);
  })]]);
}))]);;
...
$elf["send:"]("String")["send:args:"]("set:to:", ["clone:", (function(body) { body.type = "Method"; return body; })((function (_) {
  var self = this, $elf = Object.create(self); $elf.proto = self; $elf.delegates = [];
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("clone:", [_]); })
  $elf["_"] = (_ && _.type === "Array") ? _[0] : ((typeof _ !== "undefined") ? _ : nil);
  return self;
}))]);;
...
$elf["send:"]("traits")["send:args:"]("set:to:", ["Point", $elf["send:"]("Object")["send:args:"]("clone:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
  var $elf = this.clone();
  return nil;
})]])]);

$elf["send:"]("traits")["send:"]("Point")["send:args:"]("set:to:", ["println", (function(body) { body.type = "Method"; return body; })((function () {
  var self = this, $elf = self.clone();
  $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("println", []); })
  return [$elf["send:"]("type"), " => x: ", $elf["send:"]("x"), ", y: ", $elf["send:"]("y")].join("")["send:"]("println");
}))]);

$elf["send:args:"]("set:to:", ["Point", $elf["send:"]("traits")["send:"]("Point")["send:args:"]("clone:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
  var $elf = this.clone();
  self["send:args:"]("set:to:", ["x", 23]);
  return self["send:args:"]("set:to:", ["y", 12]);
})]])]);

$elf["send:args:"]("set:to:", ["ComputedPoint", $elf["send:"]("traits")["send:"]("Point")["send:args:"]("clone:", [[(function (ctx, fn) { fn.__context = ctx; return fn; })($elf, function () {
  var $elf = this.clone();
  self["send:args:"]("set:to:", ["x", (function(body) { body.type = "Method"; return body; })((function () {
    var self = this, $elf = self.clone();
    $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("x", []); })
    return 23["send:args:"]("+", [100]);
  }))]);
  return self["send:args:"]("set:to:", ["y", (function(body) { body.type = "Method"; return body; })((function () {
    var self = this, $elf = self.clone();
    $elf.forward = (function (m) { m.type = "Method"; return m; })(function () { return self.proto["send:args:"]("y", []); })
    return ["x: ", $elf["send:"]("x")].join("");
  }))]);
})]])]);

$elf["send:args:"]("set:to:", ["point", $elf["send:"]("Point")["send:"]("clone")]);

$elf["send:"]("point")["send:"]("println");

$elf["send:args:"]("set:to:", ["computed", $elf["send:"]("ComputedPoint")["send:"]("clone")]);

$elf["send:"]("computed")["send:"]("println");
